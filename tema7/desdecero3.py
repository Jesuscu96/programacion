...
class Aplicacion:
    def __init__(self):
        ...
        for idioma in idiomas:
            ...
            self.idiomas_estado.append(estado) 

            # Crear el Checkbutton
            check = tk.Checkbutton(self.frame_check_idiomas, text=idioma, variable=estado, onvalue=True, offvalue=False, bg="gray25", fg="white", selectcolor="black", font=("Arial", 12, "bold"))
            check.pack(anchor="w")
        ...
        for plataforma in plataformas:
            ...
            # Crear el Checkbutton
            check = tk.Checkbutton(self.frame_check_plataformas, text=plataforma, variable=estado, onvalue=True, offvalue=False, bg="gray25", fg="white", selectcolor="black", font=("Arial", 12, "bold"))
            check.pack(anchor="w")
